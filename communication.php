        ...
        <div class="row">
            ...
            <div class="col col-lg-9 col-12 col-md-9 border-left pr-1">
                <div class="description_box">
                                    ...
                                    $data = $db->query("SELECT * FROM `communication` WHERE `status`='1' ORDER BY id DESC");
                                        $value = $data->fetch_object();
                                    ?>

                    <!-- <h1>Communication Committee </h1> -->
                    <div>
                        <p><?php echo !empty($value->editor1) ? $value->editor1 : ''; ?></p>

                        <!-- <ul>
                            <li>Mr. Prashanth Rao, JSW Steel Limited (Chairman) </li>
                            <li>Mr. R P Sharma, Rashtriya Ispat Nigam Limited (Co-Chairman)</li>
                            <li>Dr. Chinmoy Samajdar, SAIL</li>
                            <li>Mr. Bibek Chattopadhyay, ArcelorMittal Nippon Steel India</li>
                            <li>Mr. Frederick Castro, JSW Steel Limited</li>
                            <li>Mr. Sarvesh Kumar, Tata Steel Limited</li>
                            <li>Mr. Sudeep Purkayastha, Jindal Steel & Power</li>
                            <li>Ms. Sonal Singh, Jindal Stainless Limited</li>
                            <li>Ms. Tanya Gupta, ESL Steel Limited</li>
                            <li>Mr. Rajesh Srivastava, Rungta Mines Limited</li>
                            <li>Mr. Ranjan Kumar Upadhyay, Arjas Steel Pvt Ltd</li>
                            <li>Mr. Shiladitya Chanda, INSDAG</li>
                        </ul> -->
                    </div>
