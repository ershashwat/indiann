...
$data = $db->query("SELECT * FROM `manage-governance` WHERE `cs_type`='Antitrust Guidelines' ORDER BY id DESC");
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="text-right col col-8">
            <div class="submenu"> <span><a class="active-fh btn btn-fh p-3" href="Antitrust-guidelines.php">Antitrust Guidelines </a></span>
            <span><a class="btn btn-fh p-3" href="annual-general-meeting.php">Annual General Meeting </a></span>
            <span><a class="btn btn-fh p-3" href="charter&regulation.php">Charter & Regulations </a></span>  </div>
          </div>
        </div>
        <div class="row"></div>
      </div>
