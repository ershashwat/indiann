...
$data = $db->query("SELECT * FROM `manage-Committee` WHERE `cs_type`='$id' ORDER BY id DESC");
...
// } else {
//     $cc = $_REQUEST['cc'];
//     $cc_type = ucwords(str_replace('-', ' ', $cc));
// }
?>
<style>
...
<div class="sub_heading_menu container-fluid">
  <div class="container">
    <div class="row">
      ...
      <!--    <span><a class="btn btn-fh p-3 " href="other-committee.php">Other Committee </a></span>-->
          ...
          <!-- <a href="annual.php"> -->
            <div class="steel_trend_table" style="padding: 16px; box-shadow: 0px 0px 5px #ccc; border-radius: 10px;"> <img src="assets/pdf.png" style="width: 55px; border-radius: 10px; margin: auto; margin-bottom: 11px;">
              ...
              <button class="btn btn-secondary">
                  <a href="annual.php?type=<?php echo $cstype; ?>" target="_blank">View PDF</a>
              </button>
