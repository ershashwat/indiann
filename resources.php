...
$data = $db->query("SELECT * FROM `manage-knowledge-bank` WHERE `cs_type`='Resources' ORDER BY id DESC");
        ...
        <div class="row">
            ...
            <div class="text-right col col-10">
                <div class="submenu"><span><a class="btn btn-fh p-3  " href="isa-annual-reports.php">ISA Annual Reports </a></span>
                    ...
                    <span><a class="btn btn-fh p-3 active-fh" href="resources.php"> Resources </a></span>
